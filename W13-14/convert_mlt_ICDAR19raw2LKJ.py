...
SRC_DATASET_DIR = '/opt/ml/input/data/ICDAR19_raw'  # FIXME
DST_DATASET_DIR = '/opt/ml/input/data/ICDAR19_LKJ'  # FIXME
...
def main():
    ...
    mlt_merged = MLT17Dataset(osp.join(SRC_DATASET_DIR, 'training_images'),
                             osp.join(SRC_DATASET_DIR, 'training_gt'),
                             copy_images_to=dst_image_dir)
    # mlt_valid = MLT17Dataset(osp.join(SRC_DATASET_DIR, 'ch8_validation_images'),
    #                          osp.join(SRC_DATASET_DIR, 'ch8_validation_gt'),
    #                          copy_images_to=dst_image_dir)
