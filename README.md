...
- [기본 과제 2 정리](https://github.com/star-bits/boostcampAI/blob/main/W8-9/%EC%A0%95%EB%A6%AC_Data_Augmentation.ipynb): transforms.Compose([GaussianBlur, RandomCrop, ToTensor, Resize, Normalize]), Channel order: {cv2: BGR, torch: RGB}, Dimension: {cv2: (height, width, channel), torch conv2d: (batch_size, channel, height, width)} ⭐
